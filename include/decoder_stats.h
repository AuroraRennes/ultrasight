...
typedef enum {
    ...
    DECODER_STATS_ATOM_CNT       = 0x30,
    DECODER_STATS_ATOM_BST_CNT   = 0x34,
    DECODER_STATS_ATOM_MIN_BST   = 0x38,
    DECODER_STATS_ATOM_MAX_BST   = 0x3C,
    DECODER_STATS_ATOM_SUM_BST   = 0x40,
    DECODER_STATS_ATOM_GAP_CNT   = 0x44,
    DECODER_STATS_ATOM_MIN_GAP   = 0x48,
    DECODER_STATS_ATOM_MAX_GAP   = 0x4C,
    DECODER_STATS_ATOM_SUM_GAP   = 0x50,
    ...
    DECODER_STATS_ATM_GAP_H0     = 0x78,
    DECODER_STATS_ATM_GAP_H1     = 0x7C,
    DECODER_STATS_ATM_GAP_H2     = 0x80,
    DECODER_STATS_ATM_GAP_H3     = 0x84,
    DECODER_STATS_ATM_GAP_H4     = 0x88,
    /* Atom burst histogram: 1, 2-3, 4-15, 16+ */
    DECODER_STATS_ATM_BST_H0     = 0x8C,
    DECODER_STATS_ATM_BST_H1     = 0x90,
    DECODER_STATS_ATM_BST_H2     = 0x94,
    DECODER_STATS_ATM_BST_H3     = 0x98,
} decoder_stats_reg_t;
...
static axi_reg_desc_t decoder_stats_descs[] = {
    ...
    {"Atom count",              DECODER_STATS_ATOM_CNT},
    {"Atom burst count",        DECODER_STATS_ATOM_BST_CNT},
    {"Min atom burst length",   DECODER_STATS_ATOM_MIN_BST},
    {"Max atom burst length",   DECODER_STATS_ATOM_MAX_BST},
    {"Sum atom burst length",   DECODER_STATS_ATOM_SUM_BST},
    {"Atom gap count",          DECODER_STATS_ATOM_GAP_CNT},
    {"Min atom gap length",     DECODER_STATS_ATOM_MIN_GAP},
    {"Max atom gap length",     DECODER_STATS_ATOM_MAX_GAP},
    {"Sum atom gap length",     DECODER_STATS_ATOM_SUM_GAP},
};
...
static inline void decoder_stats_print_detailed(decoder_stats_t *h)
{
    ...
    uint32_t atm_cnt     = axi_regs_read(h, DECODER_STATS_ATOM_CNT);
    uint32_t atm_bst_cnt = axi_regs_read(h, DECODER_STATS_ATOM_BST_CNT);
    uint32_t atm_min_bst = axi_regs_read(h, DECODER_STATS_ATOM_MIN_BST);
    uint32_t atm_max_bst = axi_regs_read(h, DECODER_STATS_ATOM_MAX_BST);
    uint32_t atm_sum_bst = axi_regs_read(h, DECODER_STATS_ATOM_SUM_BST);
    uint32_t atm_gap_cnt = axi_regs_read(h, DECODER_STATS_ATOM_GAP_CNT);
    uint32_t atm_min_gap = axi_regs_read(h, DECODER_STATS_ATOM_MIN_GAP);
    uint32_t atm_max_gap = axi_regs_read(h, DECODER_STATS_ATOM_MAX_GAP);
    uint32_t atm_sum_gap = axi_regs_read(h, DECODER_STATS_ATOM_SUM_GAP);
    ...
    uint32_t atm_gap_hist[] = {
        axi_regs_read(h, DECODER_STATS_ATM_GAP_H0),  /* 0       */
        axi_regs_read(h, DECODER_STATS_ATM_GAP_H1),  /* 1-4     */
        axi_regs_read(h, DECODER_STATS_ATM_GAP_H2),  /* 5-15    */
        axi_regs_read(h, DECODER_STATS_ATM_GAP_H3),  /* 16-255  */
        axi_regs_read(h, DECODER_STATS_ATM_GAP_H4),  /* 256+    */
    };
    uint32_t atm_bst_hist[] = {
        axi_regs_read(h, DECODER_STATS_ATM_BST_H0),  /* 1       */
        axi_regs_read(h, DECODER_STATS_ATM_BST_H1),  /* 2-3     */
        axi_regs_read(h, DECODER_STATS_ATM_BST_H2),  /* 4-15    */
        axi_regs_read(h, DECODER_STATS_ATM_BST_H3),  /* 16+     */
    };
    ...
    _decoder_hist("Atom gap dist.",   gap_labels, atm_gap_hist, 5);
    _decoder_hist("Atom burst dist.", bst_labels, atm_bst_hist, 4);
}
